...
public class OperatorLogin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/operator2.png"))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(a.equals("") || b.equals("")){
            ...
            try{
                ...
                String q = "Select * from operator_table;";
                ResultSet rs = st.executeQuery(q);
                while(rs.next()){
                    String user = rs.getString("Operator_Name");
                    String pass = rs.getString("Operator_Passkey");
