...
public class AddStaff extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("  Add Counting Staff");
            ...
            if(val.isText(a) && val.isText(b)){
                if(val.isTen(c) && val.isNotText(c) && val.isSpecialChar(c)) {
                    if(val.isNotText(d) && val.isNotSpecialChar(d)){
                        try{
                            PreparedStatement ps = con.prepareStatement("insert into staff_table(Staff_Name, Staff_Contact, Staff_City, Staff_Passkey, Admin_Id) values(?,?,?,?,?)");
                            ps.setString(1, a);
                            ps.setString(3, b);
                            ps.setString(2, c);
                            ps.setString(4, d);
