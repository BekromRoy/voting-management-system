...
public class StaffLogin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("COUNTING STAFF LOGIN");
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/staff (1).png"))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(a.equals("") || b.equals("")){
            ...
            try{
                ...
                String q = "Select * from staff_table;";
                ResultSet rs = st.executeQuery(q);
                while(rs.next()){
                    String user = rs.getString("Staff_Name");
                    String pass = rs.getString("Staff_Passkey");
                    String Id = rs.getString("Staff_Id");
                    if(a.equals(user)){
                        if(pass.equals(b)){
                            this.dispose();
                            VoteResult ml =new VoteResult();
                            ml.setVisible(true);
