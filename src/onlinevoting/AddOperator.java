            ...
            if(val.isText(a) && val.isText(b)){
                if(val.isTen(c)  && val.isNotText(c) && val.isSpecialChar(c)) {
                    if(val.isNotText(d) && val.isNotSpecialChar(d)){
                        try{
                            PreparedStatement ps = con.prepareStatement("insert into operator_table(Operator_Name, Operator_Contact, Operator_City, Operator_Passkey, Admin_Id) values(?,?,?,?,?)");
                            ps.setString(1, a);
                            ps.setString(3, b);
                            ps.setString(2, c);
                            ps.setString(4, d);
                            ps.setString(5, e);
                            ps.executeUpdate();
                            JOptionPane.showMessageDialog(this,"Operator added succesfully");
                            jTextField1.setText("");
                            jTextField2.setText("");
                            jTextField3.setText("");
                            jTextField4.setText("");
